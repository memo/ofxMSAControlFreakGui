        ...
        namespace gui {
            ...
            public:
                ...
                void onMouseMove(int x, int y) {
                    ...
                    mouseOverIndex = floor(ofMap(y + getConfig().layout.buttonHeight/2, a, b, 0, paramT->getNumLabels()-1, true));
                }
                ...
                void onDraw() {
                    ...
                    layout.height = height = getConfig().layout.buttonHeight * (numLabels + 0.5) + 3;
