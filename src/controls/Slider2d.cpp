...
//            
//            void Slider2d::setup() {
//                setSize(pconfig->layout.slider2DSize.x, pconfig->layout.slider2DSize.y + pconfig->layout.slider2DTextHeight);
//                point.x = ofMap((*value).x, min.x, max.x, x, x+width);
//                point.y = ofMap((*value).y, min.y, max.y, y, y+height-pconfig->layout.slider2DTextHeight);
//            }
////            
...
//                
//                if(point.y > y+height - pconfig->layout.slider2DTextHeight)			point.y = y + height - pconfig->layout.slider2DTextHeight;
//                else if(point.y < y)				point.y = y;
//                
//                if(lock){
//                    (*value).x = ofMap(point.x, x, x+width, min.x, max.x);
//                    (*value).y = ofMap(point.y, y, y+height-pconfig->layout.slider2DTextHeight, min.y, max.y);
//                }
//            }
//            
...
//                pointv.y = ofMap((*value).y, min.y, max.y, y, y+height-pconfig->layout.slider2DTextHeight);
//                
...
//                
//                ofFill();
//                setColor(pconfig->colors.slider.full);
//                ofRect(0, 0, width, height - pconfig->layout.slider2DTextHeight);
//                
//                ofFill();
//                setBGColor();
//                ofRect(0, height-pconfig->layout.slider2DTextHeight, width, pconfig->layout.slider2DTextHeight);
//                
//                setTextColor();
//                pconfig->drawString(name+"\nx:"+ofToString(value->x, 2)+"\ny:"+ofToString(value->y, 2), 3, height+15-pconfig->layout.slider2DTextHeight);
//                
//                setTextColor();
//                ofCircle(pointv.x-x, pointv.y-y, 2);
//                
//                setTextColor();
//                ofLine(pointv.x-x, 0, pointv.x-x, height-pconfig->layout.slider2DTextHeight);
